...
// 	ResultSet rs = null;
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:30306/DB_jspEjercicio2_9", "root", "user");


//>>>>>>NO UTILIZAR STATEMENT EN QUERIES PARAMETRIZADAS
//       Statement s = conexion.createStatement();
//       String insercion = "INSERT INTO usuario VALUES (" + Integer.valueOf(request.getParameter("numero"))
